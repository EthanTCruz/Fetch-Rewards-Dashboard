...
class RNNPredictor:
    def __init__(self,dataFileLocation: str = s.dataFileLocation,step_size: int = 30) -> None:
    ...
    def Train_Model(self):
        ...
        tf.keras.models.save_model(model=model,filepath=s.ModelFile)
        return model
    ...
    def Predict(self,train_model:bool = True):
        if train_model:
            ...
            model = tf.keras.models.load_model(filepath=s.ModelFile)
        ...
        for i in range(number_of_prediction_steps):
